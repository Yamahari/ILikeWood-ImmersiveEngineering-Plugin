...
public final class ImmersiveEngineeringWoodenItemTiers {
    public static final IWoodenItemTier TREATED_WOOD = new DefaultWoodenItemTier(ImmersiveEngineeringWoodTypes.TREATED_WOOD,
        Constants.IE_MOD_ID,
        Constants.TREATED_WOOD,
        () -> Ingredient.of(ImmersiveEngineeringPlugin.BLOCK_REGISTRY.getObject(ImmersiveEngineeringWoodTypes.TREATED_WOOD, WoodenBlockType.PANELS)));
